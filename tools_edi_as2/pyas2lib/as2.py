...
from odoo.addons.tools_edi_as2.pyas2lib.cms import (
    compress_message,
    decompress_message,
    decrypt_message,
    encrypt_message,
...
from odoo.addons.tools_edi_as2.pyas2lib.exceptions import (
    AS2Exception,
    DuplicateDocument,
...
from odoo.addons.tools_edi_as2.pyas2lib.utils import (
    canonicalize,
    extract_first_part,
    make_mime_boundary,
    mime_to_bytes,
...
class Organization(object):
    ...
    :param id: The unique integer id of record in table {Odoo}
